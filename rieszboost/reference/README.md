...
| `chernozhukov-riesznet/` | [2110.03031](https://arxiv.org/abs/2110.03031) | Chernozhukov et al., *RieszNet and ForestRiesz*. NN/RF implementations of Riesz regression. |
| `singh-krrr/` | [2102.11076](https://arxiv.org/abs/2102.11076) | Singh, *Kernel Ridge Riesz Representers*. Closed-form RKHS estimator. |
...
for entry in \
  ...
  "chernozhukov-riesznet:2110.03031" \
  "singh-krrr:2102.11076" \
