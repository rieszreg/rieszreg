...
A learner package in the [RieszReg family](https://github.com/rieszreg/rieszreg), sharing the `rieszreg.RieszEstimator` orchestrator and the `Estimand` / `Loss` family.
