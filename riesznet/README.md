...
Neural-network backend for [RieszReg](https://github.com/rieszreg/rieszreg). Trains the Riesz representer α(x) of a linear functional θ(P) = E[m(Z, g₀)] using PyTorch.
